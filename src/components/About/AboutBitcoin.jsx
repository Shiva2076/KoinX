...
import BCDImage from '../../assets/BCD.png';
    ...
    <section className="about-bitcoin">
      ...
      <div className="about-bitcoin__content">
        ...
        <p>
          ...
          pellentesque auctor amet. Nunc sagittis libero adipiscing cursus felis pellentesque
          interdum. Odio cursus phasellus velit in senectus enim dui. Turpis tristique
          placerat interdum sed volutpat. Id imperdiet magna eget eros donec cursus nunc.
          Mauris faucibus diam mi nunc praesent massa turpis a. Integer dignissim augue
          viverra nulla et quis lobortis phasellus. Integer pellentesque enim convallis
          ultricies at.
        </p>
        <p>
          Fermentum hendrerit imperdiet nulla viverra faucibus. Sit aliquam massa vel
          convallis duis ac. Mi adipiscing semper scelerisque porttitor pulvinar nunc risus.
          Fermentum potenti iaculis lacinia congue ipsum fames amet dui. Purus ultrices
        ...
        <div className="about-bitcoin__images">
          <div className="image-container">
            <img src={ABCImage} alt="Calculate your profits" />
          </div>
          <div className="image-container">
            <img src={BCDImage} alt="Calculate your tax liability" />
          </div>
        </div>
        <hr />
        <p>
